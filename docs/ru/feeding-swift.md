...
<figure>
    ...
    <figcaption>Маленькие стрижи хватают пальцы</figcaption>
</figure> 
</div>
...
# Теперь по видам корма подробно {#types-of-food}
## Сверчки
...
- Трутневый расплод — через пчеловодов
...
## Способы кормления
/процесс кормления, описание текстом/
...
Лапы насекомых, головы, скорлупки можно сохранить в морозилке и добавлять зимой в корм для синичек