...
### Неотложные состояния
  ...
  Стрижу нужен внешний обогрев и требуется начать действовать по [cхеме выведения из истощения](exhaustion.html), для переваривания даже правильного корма у птенца сил может не быть.
...
### Вес и состояние истощения
  ...
  При сильном истощении важно восстанавливать пищеварение плавно и щадяще, с использованием вытяжки из насекомых (ссылка?)
