...
### Неотложные состояния
  - Высокая степень истощения. При истощении лапки и тело холодные, при крайнем истощении могут быть ледяными.
   
  Стрижу требуется внешний обогрев и начать срочное выведение из голода (например, физраствором + с помощью выжимки из таракана). Для переваривания даже правильного корма у птенца сил может не быть.
  
  [Подробнее: Истощение](exhaustion.html)
  
  - Укус кошки - требуется укол антибиотика у ветеринара - от пастереллы. Взрослому стрижу Ciprofloxacin, птенцу Amoxicillin/clavulanate. Ciprofloxacin может повлиять на рост пера, поэтому птенцу его стараются не давать.
