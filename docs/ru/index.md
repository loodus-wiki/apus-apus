...
### Неотложные состояния
  ...
  Стрижу нужен внешний обогрев и требуется начать действовать по
  
  [cхеме выведения из истощения](exhaustion.html), для переваривания даже правильного корма у птенца сил может не быть.
  
  [Подробнее: Истощение](exhaustion.html)
  
  - Укус кошки - требуется курс антибиотика у ветеринара - от пастереллы. 
