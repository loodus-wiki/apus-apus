...
<div class="emergency-box box-warning">
  <h3>⚠️ Высокая степень истощения</h3>
  <p><strong>Признаки:</strong> вес птенца меньше 25 г, взрослой птицы — меньше 35 г.</p>
  <p>Стрижу нужен внешний обогрев и требуется начать действовать по схеме выведения из истощения, так как сил на переваривание даже правильного корма может не быть.</p>
  <a href="exhaustion.html" class="btn-emergency">👉 Схема выведения из истощения</a>
</div>

<div class="emergency-box box-danger">
  <h3>🩸 Укус кошки (Опасность пастереллёза)</h3>
  <p>Требуется <strong>срочный визит к ветеринару</strong> для получения курса антибиотика от пастереллы. Без лечения смерть может наступить за несколько часов!</p>
  <ul>
    <li><strong>Взрослому стрижу:</strong> Ciprofloxacin</li>
    <li><strong>Птенцу:</strong> Amoxicillin / clavulanate <em>(Ciprofloxacin может повлиять на рост пера, поэтому птенцу его стараются не давать)</em></li>
  </ul>
</div>
...
Очень часто птенцы попадают к вам уже обезвоженными и с заметным истощением. Действовать надо быстро, чтобы с минимальными последствиями вывести птицу из этого состояния.

Критический для жизни птенца вес — 18−22 грамма. Истощённые стрижата обычно весят **20−27 грамм**.

Если остались сомнения, вот [определитель с картинками возраста птицы по дням](identifying-swift.html)
...
<div class="emergency-box box-info">
  <h3>ℹ️ Будьте аккуратны с когтями!</h3>
  <p>Не бойтесь перекладывать стрижа в коробку. Даже если стриж на вас шипит, он вас не клюнет. <strong>Будьте аккуратны с когтями</strong>, он может сильно их сжать, например, зацепившись за палец.</p>
</div>
